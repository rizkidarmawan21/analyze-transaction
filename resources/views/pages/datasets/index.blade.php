<x-app-layout>
    <div x-data="{
                    ...
                    <tbody>
                        @foreach ($datasets as $dataset)
                            <tr class="bg-slate-100/25">
                                ...
                                <td class="border border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <p class="text-black dark:text-white">
                                        <a href="{{ asset($dataset->file_name) }}"
                                            class="hover:text-primary">{{ $dataset->file_name }}</a>
                                    </p>
                                </td>
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <div class="flex items-center space-x-3.5">
                                        ...
                                        <a href="{{ route('datasets.show', $dataset->id) }}" class="hover:text-primary">
        ...
        @include('pages.datasets.modal-create')
