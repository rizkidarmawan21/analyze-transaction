        ...
        <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6" x-data="{ selected: $persist('Dashboard') }">
            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    {{-- <li>
                        ...
                        <div class="translate transform overflow-hidden"
                            ...
                            <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                                <x-dashboard.sidebar.single-list :active="true" label="Calendar" url="calendar.html">
                                    Calendar
                    ...
                    <x-dashboard.sidebar.single-list :active="request()->routeIs('datasets.index')" label="Datasets" :url="route('datasets.index')">
                    ...
                    <x-dashboard.sidebar.single-list :active="request()->routeIs('analyze.index')" label="Analyze" :url="route('analyze.index')">
