<x-auth-layout>
    ...
    <!-- ===== Page Wrapper Start ===== -->
    <div class="flex h-screen overflow-hidden items-center">
        <!-- ===== Content Area Start ===== -->
        <div class="relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden">
            ...
            <main>
                <div class="flex justify-center items-center">
                    <!-- ====== Forms Section Start -->
                    <div
                        class="w-full mx-10 xl:w-1/3 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
